        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RestrictedToUserIds = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FilledForms_AspNetUsers_SubmittedById",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShowInAnswers = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Answers_FilledForms_FormId",
                        column: x => x.FormId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TemplateTagTagId = table.Column<int>(type: "integer", nullable: true),
                    TemplateTagTemplateId = table.Column<int>(type: "integer", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TemplateTags_TemplateTags_TemplateTagTemplateId_TemplateTag~",
                        columns: x => new { x.TemplateTagTemplateId, x.TemplateTagTagId },
                        principalTable: "TemplateTags",
                        principalColumns: new[] { "TemplateId", "TagId" });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FilledForms_SubmittedById",
                table: "FilledForms",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TemplateTags_TemplateTagTemplateId_TemplateTagTagId",
                table: "TemplateTags",
                columns: new[] { "TemplateTagTemplateId", "TemplateTagTagId" });
        }
